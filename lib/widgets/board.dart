...
import 'package:tictactoe_acl/widgets/o.dart';
import 'package:tictactoe_acl/widgets/x.dart';
...
class _BoardState extends State<Board> {
        ...
        builder: (context,
          ...
          if (state.key == BoardState.Done) {
            ...
            Widget body = state.value == 'X'
                ? X(50, 20)
                : (state.value == 'O'
                    ? O(50, AppColors.green)
                    : Row(
                        children: <Widget>[X(50, 20), O(50, AppColors.green)],
                      ));
  ...
  Widget _buildBox(int i, int j, dynamic item) {
    double height = 80;
    double width = 60;
